      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
            Why <span className="text-muted-foreground">PDF</span>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  We believe that once you purchase something, it should belong
                  to you permanently.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-primary">4EVER</span> delivers
                  professional-grade tools that rival or exceed industry
                  standards—without the ongoing subscription trap.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  need it for gas. One purchase, lifetime access. Trust me, i've
                  been there.
                </p>
              </div>
            </div>
          ...
          <div className="bg-card dark:bg-background border border-border rounded-2xl p-8 shadow-lg">
            <h3 className="text-2xl font-bold text-foreground mb-6 text-center">
              The <span className="text-muted-foreground">PDF</span>
              <span className="text-primary">4EVER</span> Promise
            </h3>
